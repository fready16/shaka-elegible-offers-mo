 ...
 * 2020-11-11T13:55:08.359-05:00
 * Generated source version: 3.4.0
 *
 */
@WebServiceClient(name = "retrieveOfferings_v1",
                  wsdlLocation = "file:/C:/synopsis/motor/ofertas-elegibles-moviles/shaka-elegiblefoffers-mo/src/main/resources/wsdl/ro/v1.wsdl",
...
public class RetrieveOfferingsV1_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/synopsis/motor/ofertas-elegibles-moviles/shaka-elegiblefoffers-mo/src/main/resources/wsdl/ro/v1.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RetrieveOfferingsV1_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/synopsis/motor/ofertas-elegibles-moviles/shaka-elegiblefoffers-mo/src/main/resources/wsdl/ro/v1.wsdl");
        }
        WSDL_LOCATION = url;
    }
