...
public class OfferingsApiController {
	...
	public ResponseEntity<ResponseType> getOfferings(
		...
		MobileElegibleOffersRequest meor = appRequest.fromParamstoBody(type, correlationId, name, isBundle,
				lifeCycleStatus, categoryId, categoryName, subcategoryId, subcategoryName, channelId, channelName,
				...
				productOfferingPriceEndPriceAmout, fields, creditScore, creditLimit, region, stateOrProvince,
				...
				broadbandMaxDlDataRate, broadbandConnection, isRetention, productOfferingCatalogId, isUpgrade, action,
				commercialAreaId, siteId, productOrderId, planId, product, planGroup, planRankInitial, planRank,
				planCommitmentDuration, currentOffering, sourceType, networkTechnology, serviceabilityMaxSpeed,
				serviceabilityId, invoiceCompany, orderSubType, subscriberGroupValue, excludeOffersId,
