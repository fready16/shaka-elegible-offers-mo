...
public class IntegerWrapper  implements Serializable {
  ...
  public IntegerWrapper id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public IntegerWrapper name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public IntegerWrapper description(String description) {
  ...
  **/
  ...
  public IntegerWrapper validFor(TimePeriodType validFor) {
  ...
  **/
  ...
  public IntegerWrapper objectCharacteristicValue(ObjectCharacteristicValueType objectCharacteristicValue) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, integerWrapper.id) &&
        Objects.equals(this.name, integerWrapper.name) &&
        Objects.equals(this.description, integerWrapper.description) &&
        Objects.equals(this.validFor, integerWrapper.validFor) &&
        Objects.equals(this.productSpecCharacteristicValue, integerWrapper.productSpecCharacteristicValue) &&
        Objects.equals(this.objectCharacteristicValue, integerWrapper.objectCharacteristicValue);
  }
