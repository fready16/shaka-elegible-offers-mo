 ...
 *               &amp;lt;maxLength value="255"/&amp;gt;
 *               &amp;lt;pattern value="AC|AS|CE|IN|NA|PA|PC|PS|SU|SC"/&amp;gt;
 *             &amp;lt;/restriction&amp;gt;
 *           &amp;lt;/simpleType&amp;gt;
 *         &amp;lt;/element&amp;gt;
...
@XmlType(name = "ServiceStatus_RetrieveServiceByMaskResponse", propOrder = {
    "code",
    "isDefault",
    "isObsolete",
    "value"
})
public class ServiceStatusRetrieveServiceByMaskResponse {
